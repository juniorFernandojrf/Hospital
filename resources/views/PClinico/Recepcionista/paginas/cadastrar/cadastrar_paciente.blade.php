            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body">
                            <form id="registrationForm" action="{{ route('register_utente') }}" method="POST"
                                class="p-3">
                                @csrf
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('nome') is-invalid @enderror"
                                            name="nome" placeholder="Informe seu Nome" value="{{ old('nome') }}"
                                            required minlength="3" maxlength="100" pattern="^[a-zA-Z\s]+$" title="Somente letras e espaços">
                                        @error('nome')
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control @error('senha') is-invalid @enderror"
                                            name="senha" placeholder="Informe sua Senha" required minlength="6" maxlength="20" title="Informe um email válido (ex: exemplo@dominio.com)>
                                        @error('senha')
                                            <div class="invalid-feedback" >{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="password"
                                            ...
                                            name="senha_confirmation" placeholder="Confirme sua Senha" required >
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="tel" class="form-control @error('telefone') is-invalid @enderror"
                                            name="telefone" placeholder="Informe seu Telefone" value="{{ old('telefone') }}"
                                            required >
                                        @error('telefone')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('morada') is-invalid @enderror"
                                            name="morada" placeholder="Informe sua Morada" value="{{ old('morada') }}"
                                            required  pattern="\d{9}" title="Apenas números, 9 dígitos">
                                        @error('morada')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            ...
                                            name="codigoPostal" placeholder="Informe o Código Postal"
                                            value="{{ old('codigoPostal') }}" required pattern="\d{4,10}" title="Somente números, entre 4 e 10 dígitos">
                                        @error('codigoPostal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="date"
                                            ...
                                            name="dataAnivers" value="{{ old('dataAnivers') }}" required>
                                        @error('dataAnivers')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col-md-4">
                                        <label for="inputFinancialEntity"
                                            class="form-label fw-semibold">Seguradora</label>
                                        <input type="text"
                                    ...
                                    <div class="col-md-4">
                                        <label for="inputUserNumber" class="form-label fw-semibold">Número
                                            Seguradora</label>
                                        <input type="text"
                                            class="form-control @error('numSegura') is-invalid @enderror"
                                            id="inputUserNumber" name="numSegura"
                                            placeholder="Informe o Número de Utente" value="{{ old('numSegura') }}" pattern="\d{5,10}" title="Somente números, entre 5 e 10 dígitos">
                                        @error('numSegura')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="text-center mt-3">
                                    <p>Já tem uma conta? <a href="{{ route('login') }}" class="text-primary">Entrar</a>
                                    </p>
                                </div>
                            </form>
                        </div>
