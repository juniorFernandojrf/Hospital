...
<!-- Mirrored from welly.dexignzone.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jun 2024 15:20:46 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('../assetes/vendor/chartist/css/chartist.min.css') }}">
    <link href="{{ asset('../assetes/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet">
    <link href="{{ asset('../assetes/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') }}"
        rel="stylesheet">
    <link href="{{ asset('../assetes/css/style.css') }}" rel="stylesheet">

    <!-- Datatable -->
    <link href="{{ asset('../assetes/vendor/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('../assetes/images/logo.png') }}" alt="">
                <img class="logo-compact" src="{{ asset('../assetes/images/logo-text.png') }}" alt="">
                <img class="brand-title" src="{{ asset('../assetes/images/logo-text.png') }}" alt="">
            </a>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Header start
        ***********************************-->
        @include('PClinico.Recepcionista.layout.topo')
        <!--**********************************
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
        @include('PClinico.Recepcionista.layout.menu')
        <!--**********************************
            Sidebar end
        ***********************************-->
        ...
        ***********************************-->
        ...
        <!--**********************************
            Footer start
        ***********************************-->
        @include('PClinico.Recepcionista.layout.footer')
        <!--**********************************
            Footer end
        ***********************************-->
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('../assetes/vendor/global/global.min.js') }}"></script>
    <script src="{{ asset('../assetes/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>
    <script src="{{ asset('../assetes/vendor/chart-js/chart.bundle.min.js') }}"></script>
    <script src="{{ asset('../assetes/js/custom.min.js') }}"></script>
    <script src="{{ asset('../assetes/js/deznav-init.js') }}"></script>
    <script src="{{ asset('../assetes/vendor/bootstrap-datetimepicker/js/moment.js') }}"></script>
    <script src="{{ asset('../assetes/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>
    <!-- Chart piety plugin files -->
    <script src="{{ asset('../assetes/vendor/peity/jquery.peity.min.js') }}"></script>

    <!-- Apex Chart -->
    <script src="{{ asset('../assetes/vendor/apexchart/apexchart.js') }}"></script>

    <!-- Datatable -->
    <script src="{{ asset('../assetes/vendor/datatables/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('../assetes/js/plugins-init/datatables.init.js') }}"></script>

    <!-- Dashboard 1 -->
    <script src="{{ asset('../assetes/js/dashboard/dashboard-1.js') }}"></script>
    <script>
        $(function() {
