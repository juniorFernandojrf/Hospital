        ...
        <div class="container-fluid">
            ...
            <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
                ...
                <a href="javascript:void(0)" class="btn btn-primary me-3" data-bs-toggle="modal"
                    data-bs-target="#addOrderModal">Consultar</a>

                <a href="javascript:void(0)" class="btn btn-primary me-3" data-bs-toggle="modal"
                    data-bs-target="#addOrderModall">Solicitar Exame</a>

                <a href="{{ route('paciente_detalhes') }}" class="btn btn-primary me-3">Prontuario</a>
            ...
            <div class="form-head page-titles d-flex mb-md-4">
                <div class="d-sm-flex d-block mb-0 align-items-end">
                    <ul class="nav nav-pills review-tab me-3 mb-2">
                        ...
                        <li class="nav-item">
                            <a href="#navpills-2" class="nav-link" data-bs-toggle="tab" aria-expanded="false">Triagem</a>
                        </li>
