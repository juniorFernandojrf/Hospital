            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            <a href="" class="btn btn-primary me-3">+ Novo </a>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example3" class="display min-w850">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img class="rounded-circle" width="35" src="{{ asset('../assetes/images/profile/small/pic1.jpg') }}" alt=""></td>
                                        <td>Tiger Nixon</td>
                                        <td>Architect</td>
                                        <td>Male</td>
                                        <td>M.COM., P.H.D.</td>
